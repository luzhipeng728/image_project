...
class Settings:
    ...
    DEEPINFRA_API_KEY: str = os.getenv("DEEPINFRA_API_KEY", "it4UO7bizCjvKEbtxEGhkOQGCwsQlyag")
    HYPRLAB_API_KEY: str = os.getenv("HYPRLAB_API_KEY", "hypr-lab-AhlUmIPK999Z51T1zq3sT3BlbkFJMtsLVnBefsOcvFSJSlNV")
